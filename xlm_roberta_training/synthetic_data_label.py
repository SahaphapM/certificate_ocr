...
if __name__ == "__main__":
    ...
    save_dataset(train_data, "datasets/train_data_label.json")
    # คือข้อมูลที่ใช้ตรวจสอบความถูกต้องของโมเดล
    save_dataset(val_data, "datasets/val_data_label.json")
    # คือข้อมูลที่ใช้ทดสอบความถูกต้องของโมเดล
    save_dataset(test_data, "datasets/test_data_label.json")
